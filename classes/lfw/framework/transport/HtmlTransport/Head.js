...
lassi.Class('lfw.framework.transport.HtmlTransport.Head', {

  construct: function Head() {
    this.items = [];
  ...
  add: function(tag, attributes, content) {
  ...
  addLink: function(rel, href, attributes) {
  ...
  addMetaProperty: function(property, content) {
    this.addMeta({property: property, content: content});
  },

  addMetaName: function(name, content) {
