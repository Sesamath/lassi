...
lassi.Class('lfw.entities.Manager', {
   ...
   * @private
   */
  initializeEntityStorage: function(entity, next) {
    var _this = this
   ...
   */
  initializeStorage: function(next) {
    var _this = this
    flow()
      .seq(function() {
        var _next = this;
   ...
   * @private
   */
  dropEntityIndexes: function(entity, next) {
    var _this = this
   ...
   * @private
   */
  rebuildEntityIndexes: function(entity, next) {
    var _this = this
    var bar;
    ...
    function loadObjects(next) {
      entity.match().grab(function(error, objects) {
        ...
        bar = new ProgressBar(':bar', objects.length);
        next(null, objects);
      });
    }
